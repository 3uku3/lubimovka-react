...
import imageProhorov from "../../assets/images/prohorov.png";
import imageMosbrew from "../../assets/images/mosbrew.png";
import imageSbtg from "../../assets/images/sbtg.png";
import imagePogovorit from "../../assets/images/pogovorit.png";
    ...
    <footer className="footer">
      ...
      <div className="footer__bottom-container">
        ...
        <div className="footer__caption-container">
          ...
          />
          <a className="footer__caption-text" href="#">
            дизайн сайта — <br />shishki.collective
          </a>
          <p className="footer__caption-text">
            вёрстка и разработака — <br />студенты Яндекс.Практикума
          </p>
        </div>
      </div>
    </footer>
