        ...
        <div className="news__items">
          <article className="news__item">
            <div className="news__wrapper">
              ...
              <p className="news__text">Присылайте ваши варианты текстовых описаний.</p>
            </div>
            <p className="news__date">05 октября 2020</p>
          </article>
          <article className="news__item">
            <div className="news__wrapper">
              <h2 className="news__title">Mosbrew Brewhouse сделал свой выбор</h2>
              <p className="news__text">Грант на постановку получит пьеса «Утечка» Юлии Савиковской.</p>
            </div>
            <p className="news__date">05 октября 2020</p>
          </article>
          <article className="news__item">
            <div className="news__wrapper">
              <h2 className="news__title">«Я всегда пишу про странных женщин»</h2>
              <p className="news__text">Интервью с драматургом Мартой Райцес.</p>
            </div>
            <p className="news__date">05 октября 2020</p>
          </article>
          <article className="news__item">
